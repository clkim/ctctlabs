...
/**
 * Copied from Campaign.java but extending MutableModelObject so as to allow create/update.
 * 
 ...
 *
 */
public class Campaign2Mutable extends MutableModelObject {
	private boolean inUrls;
		
	Campaign2Mutable(HashMap<String, Object> attributes, CTCTConnection connection, boolean created) {
		...
		"<entry xmlns=\"http://www.w3.org/2005/Atom\">" +
		  ...
		  "<content type=\"application/vnd.ctct+xml\">" +
		    "<Campaign xmlns=\"http://ws.constantcontact.com/ns/1.0/\">" +
		      "<Name>Created by InvoiceNow</Name>" +
		      "<Subject>Invoice for Work Completed</Subject>" +
		      ...
		      "</EmailContent>" + 
		      "<EmailTextContent>Invoice</EmailTextContent>" +
		      "<FromEmail>" +
		        "<Email id=\"" + CTCTConnection.API_BASE.replace("https","http") + attributes.get("ConfirmedEmailPath") +"\" >" + "</Email>" +
		        "<EmailAddress>"+attributes.get("ConfirmedEmailAddress")+"</EmailAddress>" +
		      "</FromEmail>" +
		      "<ReplyToEmail>" +
		        "<Email id=\"" + CTCTConnection.API_BASE.replace("https","http") + attributes.get("ConfirmedEmailPath") +"\" >" + "</Email>" +
		        "<EmailAddress>"+attributes.get("ConfirmedEmailAddress")+"</EmailAddress>" +
