 ...
 */
public class ContactEventIterator extends ModelIterator {

	ContactEventIterator(CTCTConnection connection, String nextPage) {
	...
	public void endElement(String namespaceURI, String localName, String qName)
		...
		if(qName.equals("EmailAddress")) {
			...
			inEntry = false;
			loadedObjects.add(new ContactEvent(currentEntry, connection));
		}
	}
}
